...
13. bad_family : It is an intercept value determined by the the fact the family has divorced parents or not
...
fit2 <- lm(headaches ~ age + Physical_abuse + alcohol+ caffeine + smokes + chocolates 
           + video_games + television + games_played+ leisure_time + car 
           + bad_family -1, data=df)
...
corrgram(df, order=FALSE, lower.panel=panel.shade,
  ...
  main="Variables in the dataframe")
```
